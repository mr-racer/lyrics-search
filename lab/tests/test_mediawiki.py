...
from lab.agent.mediawiki import fetch_html, parse_article, prefers_api
...
class TestOrdering:
    ...
    def test_fandom_uses_the_api_first(self):
        ...
        assert prefers_api(FANDOM, AgentConfig().mediawiki_api_first)
    ...
    def test_wikipedia_is_scraped_first(self):
        ...
        assert not prefers_api(WIKI, AgentConfig().mediawiki_api_first)
