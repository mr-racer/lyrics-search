...
import {
  useColors, ske, brushed, thumbCoverUrl, useIsMobile, usePrefersReducedMotion,
  Spinner, SkeRange, ToggleSwitch, Knob, Segmented, StepCheck, HintBadge, InfoTip,
  Skel, CrossfadeText, AlbumCover, LazyCover, MosaicCover, BrandMark, ResultCard,
  SectionHeader, GlassCard, FeatureCard, ModeCard, Empty, StatsDivider,
  Sparkline, CompletionRing, SkeuoArcGauge, RhythmReadout, OBStageBar,
} from '../packages/musix-ui/src/index.jsx';
...
// ─── Color tokens ── moved to packages/musix-ui (imported above) ─────────────
...
// usePrefersReducedMotion — moved to packages/musix-ui (imported above).
...
// ─── Spinner ──────────────────────────────────────────────────────────────────
// Spinner, SkeRange — moved to packages/musix-ui (imported above).

// thumbCoverUrl — moved to packages/musix-ui (imported above).

// ─── AlbumCover ── moved to packages/musix-ui (imported above) ───────────────
// AlbumCover, LazyCover, MosaicCover, ToggleSwitch, Knob, ResultCard —
// moved to packages/musix-ui (imported above).
...
// ─── Brand mark ── moved to packages/musix-ui (imported above) ────────────────
...
// Skel — moved to packages/musix-ui (imported above).
...
// HintBadge — moved to packages/musix-ui (imported above).
...
// SectionHeader, Segmented — moved to packages/musix-ui (imported above).
...
// StepCheck — moved to packages/musix-ui (imported above).
...
// CrossfadeText — moved to packages/musix-ui (imported above).
...
// Empty, StatsDivider — moved to packages/musix-ui (imported above).
...
// Sparkline, RhythmReadout — moved to packages/musix-ui (imported above).
...
// SkeuoArcGauge, CompletionRing — moved to packages/musix-ui (imported above).
...
// InfoTip — moved to packages/musix-ui (imported above).
...
// OBStageBar — moved to packages/musix-ui (imported above).
...
// useIsMobile — moved to packages/musix-ui (imported above).
...
// GlassCard, FeatureCard — moved to packages/musix-ui (imported above).
...
// ModeCard — moved to packages/musix-ui (imported above).
