"""Consolidated playback tests.

Merges three former modules:
  - test_playback_influence.py  -> TestInfluence
  - test_playback_interacted.py -> TestInteracted
  - test_playback_service.py    -> TestService

Each class keeps its own ``_isolated_db`` autouse fixture: they monkeypatch the
same ``DB_PATH`` singleton to different paths, so they are scoped per class
rather than hoisted to a single module-global fixture.
"""
...
class TestInfluence:
    ...
    def test_influence_column_exists(self):
        conn = MetadataDB.get()
    ...
    def test_influence_roundtrip(self, value, stored):
    ...
    def test_influence_defaults_true_for_legacy_callers(self):
    ...
    def test_get_playback_signals_reports_influence_false(self):
        MetadataDB.record_playback_event(
...
class TestInteracted:
    ...
    def test_default_is_null_for_legacy_callers(self):
...
# --- playback_service and the underlying MetadataDB accessor -----------------
...
class TestService:
    ...
    def test_record_playback_event_writes_row(self):
        MetadataDB.record_playback_event(
            session_id="sess-1",
    ...
    def test_skipped_early_is_true_for_short_play_and_low_ratio(self):
    ...
    def test_skipped_early_is_false_for_low_ratio_but_long_play(self):
    ...
    def test_skipped_early_is_false_for_full_play(self):
        MetadataDB.record_playback_event(
            session_id="sess-1", collection_name="music", track_id="t1",
    ...
    def test_skipped_early_false_when_total_dur_missing_but_played_long(self):
    ...
    def test_skipped_early_true_when_total_dur_missing_and_short(self):
    ...
    def test_skipped_early_false_for_short_track_fully_played(self):
    ...
    def test_get_recent_dedups_by_track_id_keeping_latest(self):
    ...
    def test_get_recent_excludes_skipped_from_play_count(self):
        MetadataDB.record_playback_event(session_id="s1", collection_name="c",
    ...
    def test_get_peak_hour_applies_negative_tz_offset(self):
